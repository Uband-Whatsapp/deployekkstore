...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!existing.empty) {
      // Jika ada user lain dengan username yang sama
    ...
    // Juga update semua pesan yang dikirim user tersebut (opsional, agar username di pesan lama berubah)
    // Kita tidak lakukan agar konsisten, tapi bisa juga.
